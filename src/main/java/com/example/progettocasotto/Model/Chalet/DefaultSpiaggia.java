...
public class DefaultSpiaggia implements SpiaggiaInterface{
    ...
    public boolean addSdraioToPrenotazione(String idPrenotazione, int numSdraio) {
        ...
        int numero =random.nextInt(getSdraioLiberi(getPrenotaizioneById(idPrenotazione).getDataInizio(),getPrenotaizioneById(idPrenotazione).getDataFine()).size());
        int i=0;
        while(i<numSdraio){
            ...
            numero=random.nextInt(getSdraioLiberi(getPrenotaizioneById(idPrenotazione).getDataInizio(),getPrenotaizioneById(idPrenotazione).getDataFine()).size());
